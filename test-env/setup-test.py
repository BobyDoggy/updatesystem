...
print()
print("Ou lancer le Self-Updater (met à jour le System-Updater puis le lance) :")
print(f"    java -jar ../self-updater/target/self-updater-1.0.0-SNAPSHOT.jar self-updater-config-test.yml")
print("=" * 60)
